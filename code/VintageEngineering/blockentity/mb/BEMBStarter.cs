...
{
    /// <summary>
    /// Basis for MB Machine BE's
    /// </summary>
    public class BEMBStarter : VEMBEntityCore, IVELiquidInterface
    {
        // 1 fence - black
        // 2 platform - mid gray
        // 3 ladder - light gray
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            else
            {
                ...
                if (AnimUtil != null)
                {
                    AnimUtil.InitializeAnimator("vembstarter", null, null, new Vec3f(0f, GetRotation(), 0f));
                }
            }
            if (IsBuilt)
            {
