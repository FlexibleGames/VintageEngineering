...
{
    /// <summary>
    /// Chemical Plant Recipe in any combination <br/>
    /// 2 fluid & 1 item input<br/>
    /// 1 item & 3 fluid outputs
    /// </summary>
    public class RecipeChemPlant : IByteSerializable, IVEMachineRecipeBase<RecipeChemPlant>
    {
        /// <summary>
        ...
        IRecipeIngredient[] IVEMachineRecipeBase<RecipeChemPlant>.Ingredients
        {
            get
            {
                return Ingredients;
        ...
        IRecipeOutput[] IVEMachineRecipeBase<RecipeChemPlant>.Outputs
        {
            get
            {
                return Outputs;
        ...
        public void FromBytes(BinaryReader reader, IWorldAccessor resolver)
        {
            ...
            for (int i = 0; i < Ingredients.Length; i++)
            {
                ...
                Ingredients[i].Resolve(resolver, "VE Chemical Plant Recipe (FromBytes)");
            }
            ...
            for (int i = 0; i < Outputs.Length; i++)
            {
                ...
                Outputs[i].Resolve(resolver, "VE Chemical Plant Recipe (FromBytes)");
            }
            if (Attributes != null)
            {
