    ...
    public class GUIMetalPress : GuiDialogBlockEntity
    {
        ...
        private string GetHelpText()
        {
            ...
            if (currentRecipe != null)
            {
                ...
                outputhelptext = $"{Lang.Get("vinteng:gui-word-crafting")} {currentRecipe.Outputs[0].ResolvedItemstack.StackSize} {currentRecipe.Outputs[0].ResolvedItemstack.GetName()}"; //{Lang.Get(langcode)}";
